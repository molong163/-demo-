    ...
    return {
      ...
      calendarOptions: {
        ...
        events: [{ // 将在日历上显示的事件对象， events 可以是数组、json、函数。具体可以查看官方文档
          title: '标题1',
          start: '2022-10-11', // 事件开始时间
          end: '2022-10-30', // 事件结束时间
          // start: '事件开始事件',
          // end: '事件结束事件', // 这里要注意，end为可选参数，无end参数时该事件仅在当天展示
          backgroundColor: '#99f2b0', // 该事件的背景颜色
          borderColor: '#99f2b0', // 该事件的边框颜色
          textColor: '#F9AE26' // 该事件的文字颜色
        },
        { // 将在日历上显示的事件对象， events 可以是数组、json、函数。具体可以查看官方文档
          title: '标题2',
          start: '2022-10-21', // 事件开始时间
          end: '2022-10-31', // 事件结束时间
          // start: '事件开始事件',
          // end: '事件结束事件', // 这里要注意，end为可选参数，无end参数时该事件仅在当天展示，end不包含当前项，实际会往前一位
          backgroundColor: '#FDEBC9', // 该事件的背景颜色
          borderColor: '#FDEBC9', // 该事件的边框颜色
          textColor: '#000' // 该事件的文字颜色
        }],
